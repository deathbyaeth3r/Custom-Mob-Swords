...
public class SpiderWebProjectileEntity extends ProjectileItemEntity {
    
    public SpiderWebProjectileEntity(EntityType<SpiderWebProjectileEntity> type, World world) {
        super(type, world);
    }
    
    public SpiderWebProjectileEntity(LivingEntity entity, World world) {
        super(EntityList.SPIDERWEB_PROJETILE.get(), entity, world);
    }
    
    public SpiderWebProjectileEntity(double x, double y, double z, World world) {
        super(EntityList.SPIDERWEB_PROJETILE.get(), x, y, z, world);
    }
    
    @Override
    protected Item getDefaultItem() {
        return ItemList.SPIDER_SWORD.get();
    }
