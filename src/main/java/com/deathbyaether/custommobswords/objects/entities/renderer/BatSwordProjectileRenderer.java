...
public class BatSwordProjectileRenderer extends EntityRenderer<BatSwordProjectileEntity> {

    public static final ResourceLocation BATSWORD_ENTITY = new ResourceLocation(Main.MOD_ID, "");
    private static final RenderType field_229044_e_ = RenderType.getEntityCutoutNoCull(BATSWORD_ENTITY);
    public BatSwordProjectileRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }
    
    protected int getBlockLight(BatSwordProjectileEntity entityIn, float partialTicks) {
        return 15;
     }

     public void render(BatSwordProjectileEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
	...
	public ResourceLocation getEntityTexture(BatSwordProjectileEntity entity) {
		
		return BATSWORD_ENTITY;
	}
