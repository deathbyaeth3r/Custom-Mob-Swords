...
public class BeeStingProjectileRenderer extends EntityRenderer<BeeStingProjectileEntity> {
    ...
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(BEESTING_ENTITY);
	...
	@Override
	public ResourceLocation getTextureLocation(BeeStingProjectileEntity entity) {
