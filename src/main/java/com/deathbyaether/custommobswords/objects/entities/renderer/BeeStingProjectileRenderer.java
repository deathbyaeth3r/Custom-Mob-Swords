...
public class BeeStingProjectileRenderer extends EntityRenderer<BeeStingProjectileEntity> {
    ...
    protected int getBlockLight(BeeStingProjectileEntity entityIn, float partialTicks) {
        return 15;
     }

     public void render(BeeStingProjectileEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
        matrixStackIn.scale(2.0F, 2.0F, 2.0F);
        matrixStackIn.rotate(this.renderManager.getCameraOrientation());
        matrixStackIn.rotate(net.minecraft.util.math.vector.Vector3f.YP.rotationDegrees(180.0F));
        MatrixStack.Entry matrixstack$entry = matrixStackIn.getLast();
        net.minecraft.util.math.vector.Matrix4f matrix4f = matrixstack$entry.getMatrix();
        net.minecraft.util.math.vector.Matrix3f matrix3f = matrixstack$entry.getNormal();
     ...
     private static void func_229045_a_(IVertexBuilder p_229045_0_, net.minecraft.util.math.vector.Matrix4f p_229045_1_, net.minecraft.util.math.vector.Matrix3f p_229045_2_, int p_229045_3_, float p_229045_4_, int p_229045_5_, int p_229045_6_, int p_229045_7_) {
	...
	@Override
	public ResourceLocation getEntityTexture(BeeStingProjectileEntity entity) {
		
		return BEESTING_ENTITY;
	}
