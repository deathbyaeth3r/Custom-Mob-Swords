...
public class ChickenEggProjectileRenderer extends EntityRenderer<ChickenEggProjectileEntity> {

    public static final ResourceLocation CHICKEN_EGG_ENTITY = new ResourceLocation(Main.MOD_ID, "");
    private static final RenderType field_229044_e_ = RenderType.getEntityCutoutNoCull(CHICKEN_EGG_ENTITY);
    
    public ChickenEggProjectileRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }
    
    protected int getBlockLight(ChickenEggProjectileEntity entityIn, float partialTicks) {
        return 15;
    }

    public void render(ChickenEggProjectileEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
    ...
    @Override
    public ResourceLocation getEntityTexture(ChickenEggProjectileEntity entity) {
        return CHICKEN_EGG_ENTITY;
    }
}
