...
public class MilkSplashProjectileRenderer extends EntityRenderer<MilkSplashProjectileEntity> {

    public static final ResourceLocation MILK_SPLASH_ENTITY = new ResourceLocation("minecraft:textures/item/milk_bucket.png");
    private static final RenderType field_229044_e_ = RenderType.getEntityCutoutNoCull(MILK_SPLASH_ENTITY);
    public MilkSplashProjectileRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn);
    }
    
    protected int getBlockLight(MilkSplashProjectileRenderer entityIn, float partialTicks) {
        return 15;
     }

     public void render(MilkSplashProjectileEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
	...
	@Override
	public ResourceLocation getEntityTexture(MilkSplashProjectileEntity entity) {
		// TODO Auto-generated method stub
		return MILK_SPLASH_ENTITY;
	}
