...
import com.deathbyaether.custommobswords.objects.entities.CaveSpiderProjectileEntity;
...
public class CaveSpiderSwordItem extends SwordItem {

    public CaveSpiderSwordItem(ModItemTier swordGem, int i, int j, Properties properties) {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
		...
		if(!worldIn.isRemote) {
			...
			CaveSpiderProjectileEntity spiderweb_projectile = new CaveSpiderProjectileEntity(playerIn, worldIn);
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
        ...
        if (!world.isRemote && player.isCrouching() && player.getHeldItemMainhand().getItem() instanceof CaveSpiderSwordItem) {
