...
public class DiamondchickenSwordItem extends SwordItem {

	public DiamondchickenSwordItem(ModItemTier swordGem, int i, int j, Properties properties) {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		if (InputMappings.isKeyDown(Minecraft.getInstance().getMainWindow().getHandle(), GLFW.GLFW_KEY_LEFT_SHIFT)) {
			...
			tooltip.add(new TranslationTextComponent("tooltip.mobswords.diamondchickensword_item.hold_shift"));
